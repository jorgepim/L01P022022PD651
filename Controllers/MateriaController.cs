...
namespace L01P022022PD651.Controllers
{
    public class MateriaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MateriaNombre,UnidadesValorativas,Estado")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MateriaNombre,UnidadesValorativas,Estado")] Materia materia)
        {
            if (id != materia.Id)
            {
                return NotFound();
